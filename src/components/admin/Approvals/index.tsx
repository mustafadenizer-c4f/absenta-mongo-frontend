...
const AdminApprovals: React.FC = () => {
  ...
  const fetchPastDecisions = async () => {
    ...
    try {
      ...
      setPastRequests((data ?? []).slice(0, 50) as LeaveRequest[]);
    } catch (err: any) {
    ...
    <Box>
      ...
      <Paper>
        {loading ? (
          ...
          <Box sx={{ p: 4, textAlign: 'center' }}><Typography color="text.secondary">{langPackLabel("txtNoPendingRequests") || "No pending leave requests."}</Typography></Box>
        ) : (
          <>
            <TableContainer>
              <Table>
      ...
      <Dialog open={dialogOpen} onClose={handleDialogClose} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          ...
          <TextField label={langPackLabel("txtCommentOptional") || "Comment (optional)"} multiline rows={3} fullWidth value={comment} onChange={(e) => setComment(e.target.value)} placeholder={langPackLabel("txtAddComment") || "Add a comment..."} />
        </DialogContent>
        <DialogActions>
